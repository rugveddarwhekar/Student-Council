  ...
  <div class="container admin-land">
    <div class="row">
      <div class="center">
        ...
        <p class="info-admin">
          Use following filters for specific results.There is a COMBO SORT which sorts Year and Branch together.Branches and Year filters are sperate for sorting indivisiuls.'Skills' filter is very useful, Lorem ipsum dolor sit.TO view all details without any filters <a href="../core/display.php" target="_blank"> click here</a>
        </p>
      </div>
    </div>
  </div>
